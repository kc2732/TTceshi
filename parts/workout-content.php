    ...
    <div class="container part2">
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <p>
                        股四头肌外展训练： 左侧躺在床上，左手伸直，右手支撑保持平衡，将右腿抬起，过程中身体其他部位保持姿势。从抬起到回到起始位置为一次。
                    </p>
                    <p style="color:red;">一次保持20秒，每天3次</p>
                </div>
            </div>
        ...
        <fieldset style="line-height: 48px;font-size:135%;">
            ...
            <span style="color:red;">第一步：</span>目前生活方式的监测，包括空腹、餐前、餐后以及运动前、运动后即刻、运动后2小时、运动后4小时，以及睡前半小时内。每天的饮食，包括时间、吃饭内容、饭量，都拍手机照片记录。每天的心情、工作压力，量化记录。观察一周，了解自己的生活方式。<br>
