...
<div class="container" style="background-color: rgb(235,214,165); color:black;">
    <form action="../pages/success.php" method="post" class="dataCollection">
        ...
        <div class="question611">
            ...
            <input type="text" name="question63">
            <h4>甘油三酯(TG)具体数值（mmol/L）</h4>
            <input type="text" name="question64">
            <h4>高密度脂蛋白（HDL）具体数值（mmol/L）：</h4>
            <input type="text" name="question65">
        ...
        <div class="question791">
            ...
            <h4>药品剂量</h4>
            <input type="text" name="question81">
            <h4>使用药品的时间：</h4>
            <input type="text" name="question82">
            <h4>为什么要服用该药品？</h4>
            <input type="text" name="question83">
        </div>
        ...
        <div class="question841">
            ...
            <h4>住院地点</h4>
            <input type="text" name="question86">
            <h4>住院原因</h4>
            <input type="text" name="question87">
        </div>

        <h4>您其他已经确诊的疾病和担心的地方</h4>
        <input type="text" name="question88">
        ...
        <div class="question961">
            ...
            <h4>一周大约喝多少斤白酒</h4>
            <input type="text" name="question98">
            <h4>一周大约喝多少杯红酒</h4>
            <input type="text" name="question99">
        </div>
        ...
        <div class="question1001">
            ...
            <h4>一周大约喝多少杯茶</h4>
            <input type="text" name="question102">
            <h4>一周大约喝多少瓶含咖啡因的软饮（可乐、运动饮料等）</h4>
            <input type="text" name="question103">
        </div>
        ...
        <div class="question1041">
            ...
            <input type="text" name="question106">
        </div>
        ...
        <input type="radio" name="question108" id="question1081" value="1" >主要是坐着<br>
        <input type="radio" name="question108" id="question1082" value="2">轻微的运动（散步）<br>
        <input type="radio" name="question108" id="question1083" value="3">中毒运动（快速上下楼梯，快走）<br>
        ...
        <div class="question1091">
            <h4>是怎样的剧烈运动？</h4>
            <input type="text" name="question110">
            <h4>运动频率为一周几次？</h4>
            <input type="text" name="question111">
            <h4>每次运动多长时间</h4>
            <input type="radio" name="question112" id="question1121" value="1" >小于15分钟<br>
            <input type="radio" name="question112" id="question1122" value="2">15至30分钟<br>
            <input type="radio" name="question112" id="question1123" value="3">31至60分钟<br>
            <input type="radio" name="question112" id="question1124" value="4">60分钟以上
            <h4>这项运动你坚持了多久</h4>
            <input type="radio" name="question113" id="question1131" value="1" >小于3个月<br>
            <input type="radio" name="question113" id="question1132" value="2">3至12个月<br>
            <input type="radio" name="question113" id="question1133" value="3">大于12个月
        </div>
        ...
        <div class="question1141">
            ...
            <h4>运动频率为一周几次？</h4>
            <input type="text" name="question116">
            <h4>每次运动多长时间</h4>
            <input type="radio" name="question117" id="question1171" value="1" >小于15分钟<br>
            <input type="radio" name="question117" id="question1172" value="2">15至30分钟<br>
            <input type="radio" name="question117" id="question1173" value="3">31至60分钟<br>
            <input type="radio" name="question117" id="question1174" value="4">60分钟以上
            <h4>这项运动你坚持了多久</h4>
            <input type="radio" name="question118" id="question1181" value="1" >小于3个月<br>
            <input type="radio" name="question118" id="question1182" value="2">3至12个月<br>
            <input type="radio" name="question118" id="question1183" value="3">大于12个月
        </div>

        <h4>你的康复目标是</h4>
        <input type="text" name="question119">
